...
mod tests {
    ...
    fn final_marks_match_sample25_expected_named_students() {
        ...
        let expected_sets = expected
            .as_object()
            .expect("expected final-marks root object");
        assert!(
            expected_sets
                .get("MAT2")
                ...
                .unwrap_or(0)
                >= 8,
            "expected at least 8 named-student goldens for MAT2"
        );
        assert!(
            expected_sets
                .get("SNC2")
                ...
                .unwrap_or(0)
                >= 8,
            "expected at least 8 named-student goldens for SNC2"
        );
        for (mark_set_code, expected_set_val) in expected_sets {
            ...
            let expected_set = expected_set_val.as_object().expect("expected set object");
